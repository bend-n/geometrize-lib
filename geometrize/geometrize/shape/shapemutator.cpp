...
void setup(geometrize::Shape &s, const std::int32_t xMin,
    ...
    case geometrize::ShapeTypes::ROTATED_RECTANGLE:
        setup(static_cast<geometrize::RotatedRectangle &>(s), xMin, yMin, xMax,
              yMax);
        break;
    ...
    case geometrize::ShapeTypes::ROTATED_ELLIPSE:
        setup(static_cast<geometrize::RotatedEllipse &>(s), xMin, yMin, xMax,
              yMax);
        break;
    ...
    case geometrize::ShapeTypes::QUADRATIC_BEZIER:
        setup(static_cast<geometrize::QuadraticBezier &>(s), xMin, yMin, xMax,
              yMax);
        break;
...
void setup(geometrize::Circle &s, const std::int32_t xMin,
           const std::int32_t yMin, const std::int32_t xMax,
           const std::int32_t yMax) {
...
void setup(geometrize::Ellipse &s, const std::int32_t xMin,
           const std::int32_t yMin, const std::int32_t xMax,
           const std::int32_t yMax) {
    s.m_x = geometrize::commonutil::randomRange(xMin, xMax - 1);
    s.m_y = geometrize::commonutil::randomRange(yMin, yMax - 1);
...
void setup(geometrize::Line &s, const std::int32_t xMin,
           const std::int32_t yMin, const std::int32_t xMax,
           const std::int32_t yMax) {
    const std::pair<std::int32_t, std::int32_t> startingPoint{
        std::make_pair(geometrize::commonutil::randomRange(xMin, xMax),
                       geometrize::commonutil::randomRange(yMin, yMax - 1))};

    s.m_x1 = geometrize::commonutil::clamp(
        startingPoint.first + geometrize::commonutil::randomRange(-32, 32),
        xMin, xMax - 1);
    s.m_y1 = geometrize::commonutil::clamp(
        startingPoint.second + geometrize::commonutil::randomRange(-32, 32),
        yMin, yMax - 1);
    s.m_x2 = geometrize::commonutil::clamp(
        startingPoint.first + geometrize::commonutil::randomRange(-32, 32),
        xMin, xMax - 1);
    s.m_y2 = geometrize::commonutil::clamp(
        startingPoint.second + geometrize::commonutil::randomRange(-32, 32),
        yMin, yMax - 1);
}

void setup(geometrize::Polyline &s, const std::int32_t xMin,
           const std::int32_t yMin, const std::int32_t xMax,
           const std::int32_t yMax) {
    const std::pair<std::int32_t, std::int32_t> startingPoint{
        std::make_pair(geometrize::commonutil::randomRange(xMin, xMax),
    ...
    for (std::int32_t i = 0; i < 4; i++) {
        const std::pair<std::int32_t, std::int32_t> point{
            geometrize::commonutil::clamp(
                startingPoint.first +
                    geometrize::commonutil::randomRange(-32, 32),
                xMin, xMax - 1),
            geometrize::commonutil::clamp(
...
void setup(geometrize::QuadraticBezier &s, const std::int32_t xMin,
           const std::int32_t yMin, const std::int32_t xMax,
           const std::int32_t yMax) {
...
void setup(geometrize::Rectangle &s, const std::int32_t xMin,
           const std::int32_t yMin, const std::int32_t xMax,
           const std::int32_t yMax) {
    s.m_x1 = geometrize::commonutil::randomRange(xMin, xMax - 1);
    s.m_y1 = geometrize::commonutil::randomRange(yMin, yMax - 1);
    s.m_x2 = geometrize::commonutil::clamp(
        static_cast<std::int32_t>(s.m_x1) +
            geometrize::commonutil::randomRange(1, 32),
        xMin, xMax - 1);
    s.m_y2 = geometrize::commonutil::clamp(
...
void setup(geometrize::RotatedEllipse &s, const std::int32_t xMin,
           const std::int32_t yMin, const std::int32_t xMax,
           const std::int32_t yMax) {
    s.m_x = geometrize::commonutil::randomRange(xMin, xMax - 1);
    s.m_y = geometrize::commonutil::randomRange(yMin, yMax - 1);
...
void setup(geometrize::RotatedRectangle &s, const std::int32_t xMin,
           const std::int32_t yMin, const std::int32_t xMax,
           const std::int32_t yMax) {
    s.m_x1 = geometrize::commonutil::randomRange(xMin, xMax - 1);
    s.m_y1 = geometrize::commonutil::randomRange(yMin, yMax - 1);
...
void setup(geometrize::Triangle &s, const std::int32_t xMin,
           const std::int32_t yMin, const std::int32_t xMax,
           const std::int32_t yMax) {
    s.m_x1 = geometrize::commonutil::randomRange(xMin, xMax - 1);
    s.m_y1 = geometrize::commonutil::randomRange(yMin, yMax - 1);
...
void mutate(geometrize::Shape &s, const std::int32_t xMin,
            const std::int32_t yMin, const std::int32_t xMax,
            const std::int32_t yMax) {
    switch (s.getType()) {
    case geometrize::ShapeTypes::RECTANGLE:
        ...
        break;
    case geometrize::ShapeTypes::ROTATED_RECTANGLE:
        mutate(static_cast<geometrize::RotatedRectangle &>(s), xMin, yMin, xMax,
               yMax);
        break;
    case geometrize::ShapeTypes::TRIANGLE:
    ...
    case geometrize::ShapeTypes::ELLIPSE:
        ...
        break;
    case geometrize::ShapeTypes::ROTATED_ELLIPSE:
        mutate(static_cast<geometrize::RotatedEllipse &>(s), xMin, yMin, xMax,
               yMax);
        break;
    case geometrize::ShapeTypes::CIRCLE:
    ...
    case geometrize::ShapeTypes::LINE:
        ...
        break;
    case geometrize::ShapeTypes::QUADRATIC_BEZIER:
        mutate(static_cast<geometrize::QuadraticBezier &>(s), xMin, yMin, xMax,
               yMax);
        break;
    case geometrize::ShapeTypes::POLYLINE:
...
void mutate(geometrize::Circle &s, const std::int32_t xMin,
            const std::int32_t yMin, const std::int32_t xMax,
            const std::int32_t yMax) {
    const std::int32_t r{geometrize::commonutil::randomRange(0, 1)};
    switch (r) {
    case 0: {
        s.m_x = geometrize::commonutil::clamp(
            static_cast<std::int32_t>(s.m_x) +
                geometrize::commonutil::randomRange(-16, 16),
            xMin, xMax - 1);
        s.m_y = geometrize::commonutil::clamp(
            static_cast<std::int32_t>(s.m_y) +
                geometrize::commonutil::randomRange(-16, 16),
            yMin, yMax - 1);
        break;
    }
    case 1: {
        s.m_r = geometrize::commonutil::clamp(
            static_cast<std::int32_t>(s.m_r) +
                geometrize::commonutil::randomRange(-16, 16),
            1, xMax - 1);
        break;
    }
...
void mutate(geometrize::Ellipse &s, const std::int32_t xMin,
            const std::int32_t yMin, const std::int32_t xMax,
            const std::int32_t yMax) {
    ...
    case 1: {
        s.m_rx = geometrize::commonutil::clamp(
            static_cast<std::int32_t>(s.m_rx) +
                geometrize::commonutil::randomRange(-16, 16),
            1, xMax - 1);
        break;
    }
    case 2: {
        s.m_ry = geometrize::commonutil::clamp(
            static_cast<std::int32_t>(s.m_ry) +
                geometrize::commonutil::randomRange(-16, 16),
            1, yMax - 1);
        break;
    }
...
void mutate(geometrize::Line &s, const std::int32_t xMin,
            const std::int32_t yMin, const std::int32_t xMax,
            const std::int32_t yMax) {
    const std::int32_t r{geometrize::commonutil::randomRange(0, 1)};
...
void mutate(geometrize::Polyline &s, const std::int32_t xMin,
            const std::int32_t yMin, const std::int32_t xMax,
            const std::int32_t yMax) {
    const std::int32_t i{geometrize::commonutil::randomRange(
        static_cast<std::size_t>(0), s.m_points.size() - 1)};

    std::pair<std::int32_t, std::int32_t> point{s.m_points[i]};
    point.first = geometrize::commonutil::clamp(
        point.first + geometrize::commonutil::randomRange(-64, 64), xMin,
        xMax - 1);
    point.second = geometrize::commonutil::clamp(
        point.second + geometrize::commonutil::randomRange(-64, 64), yMin,
        yMax - 1);

    s.m_points[i] = point;
}

void mutate(geometrize::QuadraticBezier &s, const std::int32_t xMin,
            const std::int32_t yMin, const std::int32_t xMax,
            const std::int32_t yMax) {
    const std::int32_t r{geometrize::commonutil::randomRange(0, 2)};
    switch (r) {
    case 0: {
        s.m_cx = geometrize::commonutil::clamp(
            static_cast<std::int32_t>(s.m_cx) +
                geometrize::commonutil::randomRange(-8, 8),
            xMin, xMax - 1);
        s.m_cy = geometrize::commonutil::clamp(
            static_cast<std::int32_t>(s.m_cy) +
                geometrize::commonutil::randomRange(-8, 8),
            yMin, yMax - 1);
        break;
    }
    case 1: {
        // NOTE +1 on the minimum values for paranoia reasons as I wrote it that
        // way originally, not sure if it's needed
        s.m_x1 = geometrize::commonutil::clamp(
            static_cast<std::int32_t>(s.m_x1) +
                geometrize::commonutil::randomRange(-8, 8),
            xMin + 1, xMax - 1);
...
void mutate(geometrize::Rectangle &s, const std::int32_t xMin,
            const std::int32_t yMin, const std::int32_t xMax,
            const std::int32_t yMax) {
    const std::int32_t r{geometrize::commonutil::randomRange(0, 1)};
    switch (r) {
...
void mutate(geometrize::RotatedEllipse &s, const std::int32_t xMin,
            const std::int32_t yMin, const std::int32_t xMax,
            const std::int32_t yMax) {
    ...
    case 3: {
        s.m_angle = geometrize::commonutil::clamp(
            static_cast<std::int32_t>(s.m_angle) +
                geometrize::commonutil::randomRange(-16, 16),
            0, 360);
        break;
    }
...
void mutate(geometrize::RotatedRectangle &s, const std::int32_t xMin,
            const std::int32_t yMin, const std::int32_t xMax,
            const std::int32_t yMax) {
    const std::int32_t r{geometrize::commonutil::randomRange(0, 2)};
    switch (r) {
    ...
    case 2: {
        s.m_angle = geometrize::commonutil::clamp(
            static_cast<std::int32_t>(s.m_angle) +
                geometrize::commonutil::randomRange(-4, 4),
            0, 360);
        break;
    }
    }
...
void mutate(geometrize::Triangle &s, const std::int32_t xMin,
            const std::int32_t yMin, const std::int32_t xMax,
            const std::int32_t yMax) {
    const std::int32_t r{geometrize::commonutil::randomRange(0, 2)};
    switch (r) {
    ...
    case 2: {
        s.m_x3 = geometrize::commonutil::clamp(
            static_cast<std::int32_t>(s.m_x3) +
                geometrize::commonutil::randomRange(-32, 32),
            xMin, xMax);
        s.m_y3 = geometrize::commonutil::clamp(
...
void scale(geometrize::Polyline &s, const float scaleFactor) {
    ...
    for (std::size_t i = 0; i < s.m_points.size(); i += 2) {
        ...
        points.push_back({(x1 - xLen) * scaleFactor + xLen,
                          (y1 - yLen) * scaleFactor + yLen});
        points.push_back({(x1 - xLen) * scaleFactor + xLen,
                          (y2 - yLen) * scaleFactor + yLen});
    }
